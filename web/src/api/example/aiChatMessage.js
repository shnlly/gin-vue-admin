...
export const createAiChatMessage = (data) => {
  return service({
    url: '/aiChatMessage/createAiChatMessage',
    method: 'post',
    data
  })
}
...
export const deleteAiChatMessage = (params) => {
  return service({
    url: '/aiChatMessage/deleteAiChatMessage',
    method: 'delete',
    params
  })
}
...
export const deleteAiChatMessageByIds = (params) => {
  return service({
    url: '/aiChatMessage/deleteAiChatMessageByIds',
    method: 'delete',
    params
  })
}
...
export const updateAiChatMessage = (data) => {
  return service({
    url: '/aiChatMessage/updateAiChatMessage',
    method: 'put',
    data
  })
}
...
export const findAiChatMessage = (params) => {
  return service({
    url: '/aiChatMessage/findAiChatMessage',
    method: 'get',
    params
  })
}
...
export const getAiChatMessageList = (params) => {
  return service({
    url: '/aiChatMessage/getAiChatMessageList',
    method: 'get',
    params
  })
}
...
export const getSessionMessages = (params) => {
  return service({
    url: '/aiChatMessage/getSessionMessages',
    method: 'get',
    params
  })
}
...
export const sendStreamMessage = (data, onMessage, onError, onEnd) => {
  ...
  fetch(`${baseURL}/aiChatMessage/sendMessage`, {
    method: 'POST',
    headers: {
