...
type VideoContentAnalysis struct {
	global.GVA_MODEL
	VideoDescription   string `json:"videoDescription" form:"videoDescription" gorm:"column:video_description;comment:视频描述内容;size:255"`       // 视频描述
	...
	VideoTitle         string `json:"videoTitle" form:"videoTitle" gorm:"column:video_title;comment:视频标题;size:255"`                         // 视频标题
