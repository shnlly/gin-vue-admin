...
import (
	"github.com/flipped-aurora/gin-vue-admin/server/plugin/tkhelper"
	"github.com/flipped-aurora/gin-vue-admin/server/plugin/zqmcp"
...
func bizPluginV2(engine *gin.Engine) {
	...
	PluginInitV2(engine, tkhelper.Plugin)
	PluginInitV2(engine, zqmcp.Plugin)
}
